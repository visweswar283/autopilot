...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  aliases             = ["applypilotjobs.com", "www.applypilotjobs.com"]
  ...
  viewer_certificate {
    acm_certificate_arn      = "arn:aws:acm:us-east-1:860515818510:certificate/78a9f485-817e-41f6-a5f9-570680a1b2d2"
